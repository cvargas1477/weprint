        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="supervisor" class="col-md-4 col-form-label text-md-right">{{ __('Supervisor Ventas') }}</label>   
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="role" id="supervisorventas" value="supervisorventas">
                          
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="supervisor" class="col-md-4 col-form-label text-md-right">{{ __('Supervisor Taller') }}</label>   
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="role" id="supervisortaller" value="supervisortaller">
